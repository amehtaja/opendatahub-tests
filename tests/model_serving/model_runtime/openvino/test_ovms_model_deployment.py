...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            get_deployment_config_dict(model_format_name=ModelFormat.ONNX, deployment_mode=KServeDeploymentType.STANDARD),
        ...
        pytest.param(
            ...
            get_deployment_config_dict(model_format_name=ModelFormat.TENSORFLOW, deployment_mode=KServeDeploymentType.STANDARD),
        ...
        pytest.param(
            ...
            get_deployment_config_dict(model_format_name=ModelFormat.OPENVINO, deployment_mode=KServeDeploymentType.STANDARD),
